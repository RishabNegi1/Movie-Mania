...
const Addm = () => {
  ...
  return (
    <div>
      <section class=" text-red-400 body-font relative">
        <div class="container px-5 py-8 mx-auto">
          <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-xl font-medium title-font mb-4 text-emerald-500">
              Add Movie
            </h1>
          </div>
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              <div class="p-2 w-1/2">
                <div class="relative">
                  <label for="name" class="leading-7 text-sm text-fuchsia-500 font-bold">
                    Title
                  </label>
                  <input
                    type="text"
              ...
              <div class="p-2 w-1/2">
                <div class="relative">
                  <label for="email" class="leading-7 text-sm text-fuchsia-500 font-bold">
                    Rating
                  </label>
                  <input
                    type="string"
              ...
              <div class="p-2 w-full">
                <div class="relative">
                  <label for="message" class="leading-7 text-sm text-fuchsia-500 font-bold">
                    Image Link
                  </label>
                  <input
                    id="message"
